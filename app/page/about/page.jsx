  ...
  return (
    <div className={styles.aboutContainer}>
      <div className={styles.aboutContainerInner}>
        <h1>
          Tips90predict is the industry&apos;s premier source for sports
          analysis and predictions.
        </h1>
        <p>
          At Tips90predict, our main emphasis is providing you with detailed
      ...
      <div className={styles.aboutContainerInner}>
        ...
        <p>
          Tips90predict website is significant as it helps users make informed
      ...
      <div className={styles.aboutContainerInner}>
        ...
        <p>
          ...
          confident that you will never regret choosing Tips90predict. It is
          ...
          our analysis at Tips90predict.com a success rate of over 98%
        </p>
        <p>
